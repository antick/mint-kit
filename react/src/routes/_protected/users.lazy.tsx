    ...
    <main className="main-content">
      ...
      <section className="p-4">
        ...
        <div className="flex justify-end pt-4">
          <button className="border border-teal-500 text-teal-500 rounded-xl font-bold py-3 px-6 mr-2 flex items-center hover:bg-teal-500 hover:text-white">
          ...
          <button className="border border-teal-500 bg-teal-500 text-white rounded-xl font-bold py-3 px-6 ml-2 flex items-center">
            Next
